...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector("iframe"),r=new Vimeo.Player(o);r.getVideoTitle().then(function(e){console.log("title:",e)});const n=function(e){localStorage.setItem("videoplayer-current-time",e.seconds),console.log(e.seconds)},l=localStorage.getItem("videoplayer-current-time");r.setCurrentTime(JSON.parse(l)),r.on("timeupdate",(0,e.default)(n,1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.e9fac4c3.js.map