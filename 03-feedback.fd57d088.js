...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),r=document.querySelector('input[name="email"]'),l=document.querySelector('textarea[name="message"]'),o="feedback-form-state";m();const n={email:r.value,message:l.value};function u(e){""!==r.value&&""!==l.value?(e.preventDefault(),console.log(n),e.target.reset(),localStorage.removeItem(o),n.email="",n.message=""):alert("Заполните все поля формы, пожалуйста")}function s(e){n[e.target.name]=e.target.value,localStorage.setItem(o,JSON.stringify(n))}function m(){const e=localStorage.getItem(o),t=JSON.parse(e);e&&(r.value=t.email||"",l.value=t.message||"")}a.addEventListener("submit",u),a.addEventListener("input",(0,e.default)(s,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.fd57d088.js.map