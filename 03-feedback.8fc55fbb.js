...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),r=document.querySelector('input[name="email"]'),o=document.querySelector('textarea[name="message"]'),n="feedback-form-state";m();const l={};function s(e){e.preventDefault(),console.log(l),e.target.reset(),localStorage.removeItem(n),delete l.email,delete l.message}function u(e){l[e.target.name]=e.target.value,localStorage.setItem(n,JSON.stringify(l))}function m(){const e=localStorage.getItem(n),t=JSON.parse(e);e&&(r.value=t.email,o.value=t.message,t.hasOwnProperty("email")||(r.value=" "),t.hasOwnProperty("message")||(o.value=" "))}a.addEventListener("submit",s),a.addEventListener("input",(0,e.default)(u,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.8fc55fbb.js.map