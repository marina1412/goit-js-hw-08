...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),r=document.querySelector('input[name="email"]'),l=document.querySelector('textarea[name="message"]'),o="feedback-form-state";m();const n={email:r.value,message:l.value};function s(e){e.preventDefault(),console.log(n),e.target.reset(),localStorage.removeItem(o),delete n.email,delete n.message}function u(e){n[e.target.name]=e.target.value,localStorage.setItem(o,JSON.stringify(n))}function m(){const e=localStorage.getItem(o),t=JSON.parse(e);e&&(r.value=t.email,l.value=t.message,t.hasOwnProperty("email")||(r.value=" "),t.hasOwnProperty("message")||(l.value=" "))}a.addEventListener("submit",s),a.addEventListener("input",(0,e.default)(u,500));
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.aa447a2e.js.map