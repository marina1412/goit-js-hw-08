...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.getElementById("vimeo-player"),o=new Vimeo.Player(r),n="videoplayer-current-time",a=function(e){localStorage.setItem(n,e.seconds)},l=localStorage.getItem(n);l?o.setCurrentTime(JSON.parse(l)):o.setCurrentTime(0),o.on("timeupdate",(0,e.default)(a,1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.b6a10001.js.map